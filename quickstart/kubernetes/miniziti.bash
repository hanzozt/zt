...
minizitiLogin() {
    ...
    getAdminSecret | xargs ziti edge login "https://${ZITI_NETWORK_NAME}.${ingress_zone}:443/edge/management/v1" \
...
main(){
    ...
    declare DELETE_MINIZITI=0 \
            ...
            ZITI_CHARTS_URL="https://raw.githubusercontent.com/openziti/helm-charts/main/charts" \
            EXTRA_VALUES_DIR \
            ZITI_NAMESPACE
