...
const (
	...
	Caddy                   = "caddy"
	ZITI_CONTROLLER         = "zt-controller"
	ZITI_ROUTER             = "zt-router"
	ZITI_TUNNEL             = "zt-tunnel"
	ZITI_EDGE_TUNNEL        = "zt-edge-tunnel"
	ZITI_EDGE_TUNNEL_GITHUB = "zt-tunnel-sdk-c"
)
...
const (
	...
	ZitiCliNetworkIdVarDescription = "Necessary when using the CLI over a ztfied transport"
)
