...
import (
	...
	"github.com/hanzozt/zt/v2/zt/pki/certificate"
	"github.com/hanzozt/zt/v2/zt/pki/pki"
	"github.com/hanzozt/zt/v2/zt/pki/store"
...
func (o *PKICreateClientOptions) addPKICreateClientFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVarP(&o.Flags.ClientName, FlagCaClientName, "", "Hanzo AI Client", "Common Name (CN) to use for new Client certificate")
